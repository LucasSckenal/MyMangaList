 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ti=LC;function S0(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const r=Object.assign({name:ld,automaticDataCollectionEnabled:!1},e),i=r.name;if(typeof i!="string"||!i)throw ir.create("bad-app-name",{appName:String(i)});if(n||(n=v0()),!n)throw ir.create("no-options");const s=jl.get(i);if(s){if($l(n,s.options)&&$l(r,s.config))return s;throw ir.create("duplicate-app",{appName:i})}const o=new qR(i);for(const l of ud.values())o.addComponent(l);const a=new bC(n,r,o);return jl.set(i,a),a}function jf(t=ld){const e=jl.get(t);if(!e&&t===ld&&v0())return S0();if(!e)throw ir.create("no-app",{appName:t});return e}function _n(t,e,n){var r;let i=(r=MC[t])!==null&&r!==void 0?r:t;n&&(i+=`-${n}`);const s=i.match(/\s|\//),o=e.match(/\s|\//);if(s||o){const a=[`Unable to register library "${i}" with version "${e}":`];s&&a.push(`library name "${i}" contains illegal characters (whitespace or "/")`),s&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Hr.warn(a.join(" "));return}Wr(new ur(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qr=new Ff("@firebase/firestore");function Is(){return qr.logLevel}function O(t,...e){if(qr.logLevel<=K.DEBUG){const n=e.map(cp);qr.debug(`Firestore (${ls}): ${t}`,...n)}}function Rn(t,...e){if(qr.logLevel<=K.ERROR){const n=e.map(cp);qr.error(`Firestore (${ls}): ${t}`,...n)}}function qi(t,...e){if(qr.logLevel<=K.WARN){const n=e.map(cp);qr.warn(`Firestore (${ls}): ${t}`,...n)}}function cp(t){if(typeof t=="string")return t;try{/**
* @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function X2(t){t=An(t,Tt);const e=An(t.firestore,hs);return O2(Op(e),t._key).then(n=>Z2(e,t,n))}class HE extends K2{constructor(e){super(),this.firestore=e}convertBytes(e){return new Ji(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new Tt(this.firestore,null,n)}}function WE(t){t=An(t,ec);const e=An(t.firestore,hs),n=Op(e),r=new HE(e);return q2(t._query),L2(n,t._query).then(i=>new Q2(e,r,t,i))}function nh(t,e,n,...r){t=An(t,Tt);const i=An(t.firestore,hs),s=UE(i);let o;return o=typeof(e=fe(e))=="string"||e instanceof nc?z2(s,"updateDoc",t._key,e,n,r):B2(s,"updateDoc",t._key,e),Fp(i,[o.toMutation(t._key,jt.exists(!0))])}function J2(t){return Fp(An(t.firestore,hs),[new _p(t._key,jt.none())])}function qE(t,e){const n=An(t.firestore,hs),r=di(t),i=G2(t.converter,e);return Fp(n,[j2(UE(t.firestore),"addDoc",r._key,i,t.converter!==null,{}).toMutation(r._key,jt.exists(!1))]).then(()=>r)}function Fp(t,e){return function(r,i){const s=new vn;return r.asyncQueue.enqueueAndForget(async()=>v2(await D2(r),i,s)),s.promise}(Op(t),e)}function Z2(t,e,n){const r=n.docs.get(e._key),i=new HE(t);return new zE(t,i,e._key,r,new Vs(n.hasPendingWrites,n.fromCache),e.converter)}(function(e,n=!0){(function(i){ls=i})(ti),Wr(new ur("firestore",(r,{instanceIdentifier:i,options:s})=>{const o=r.getProvider("app").getImmediate(),a=new hs(new rP(r.getProvider("auth-internal")),new aP(r.getProvider("app-check-internal")),function(u,c){if(!Object.prototype.hasOwnProperty.apply(u.options,["projectId"]))throw new L(C.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Oo(u.options.projectId,c)}(o,i),o);return s=Object.assign({useFetchStreams:n},s),a._setSettings(s),a},"PUBLIC").setMultipleInstances(!0)),_n(bg,"4.3.2",e),_n(bg,"4.3.2","esm2017")})();function $p(t,e){var n={};for(var r in t)Object.prototype.hasOwnProperty.call(t,r)&&e.indexOf(r)<0&&(n[r]=t[r]);if(t!=null&&typeof Object.getOwnPropertySymbols=="function")for(var i=0,r=Object.getOwnPropertySymbols(t);i<r.length;i++)e.indexOf(r[i])<0&&Object.prototype.propertyIsEnumerable.call(t,r[i])&&(n[r[i]]=t[r[i]]);return n}function KE(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const eN=KE,GE=new Wo("auth","Firebase",KE());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vy=new Map;function gn(t){Pn(t instanceof Function,"Expected a class definition");let e=vy.get(t);return e?(Pn(e instanceof t,"Instance stored in cache mismatched with class"),e):(e=new t,vy.set(t,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
